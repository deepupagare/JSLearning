...
var result = '3' + 2;
console.log(result);
console.log(`Why result is 32 ?;  because here 7 is a string and 2 is a number so after their implicit conversion(+) it automatically gives the string value to string '72'`);
